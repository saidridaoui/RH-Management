...
?>
            <div class="collapse navbar-collapse">
                <?php
                $sqltest = mysql_query("select * from notification where seen=0 and type_person='admin'");
                        ...
                        <li class="dropdown">
                            ...
                            ?>
                              ...
                              <ul class="dropdown-menu notif" style="overflow-y: auto; overflow-x: hidden;">
                                ...
                                <li class="divider"></li>
                                <?php
                                $getNotif = mysql_query("select * from notification where type_person='admin' order by notif_id desc");
