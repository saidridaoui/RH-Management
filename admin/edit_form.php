                    ...
                    <div class="col-lg-12 col-md-11">
                        <div class="card">
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="formations.php">
                                        <tt>&laquo; retourner aux formtions</tt>
                                    </a>
                                </div>
                            </div>
                            <div class="header">
                            ...
                            <div class="content row">
                                ...
                                <div class="col-md-8">
                                    <?php
									$query = mysql_query("SELECT * FROM fonctionnaire, formation, location_details,stlocation
									WHERE fonctionnaire.fonct_id = formation.fonct_id 
                                    and fonctionnaire.fonct_id=location_details.fonct_id and stlocation.stdev_id=location_details.stdev_id and form_id = '$get_id'")or die(mysql_error());
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fonct" disabled="" class="form-control" value="<?php echo $row['firstname'].' '.$row['lastname']?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Département :</label>
                                                <input type="text" name="dep" class="form-control border-input"  value="<?php echo $row['stdev_location_name']; ?>" required disabled="" >
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" name="desc" class="form-control border-input"  value="<?php echo html_entity_decode($row['description']); ?>" style="text-align: left;" required>
