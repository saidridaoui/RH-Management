...
if(isset($_POST['submit'])){
    ...
    $test1 = mysql_query("select * from fonctionnaire where username='$username' and fonct_id != $get_id");
    if($rows=mysql_num_rows($test1)){
        $fail += ' Username exist deja.';
    }
    $test2 = mysql_query("select * from fonctionnaire where email='$email' and fonct_id != $get_id");
    if($rows=mysql_num_rows($test1)){
        $fail += ' Email exist deja.';
    }
    $test3 = mysql_query("select * from fonctionnaire where telephone='$telephone' and fonct_id != $get_id");
    ...
    if(!$fail){
        if($password == $cpassword){
            ...
            mysql_query("update fonctionnaire set firstname='$first', lastname='$last', username='$username', email='$email', telephone='$phone', password='$password', grade='$grade', designation='$designation', bureau='$bureau', date_entre='$date_entre' where fonct_id = $get_id");
            mysql_query("update location_details set stdev_id='$idd' where  fonct_id = $get_id");
            $success = 1;
        }else{
...
?>
        <script>
            //var delay = 0;		
			//setTimeout(function(){ window.location = 'fonctionnaire.php'  }, delay);  
		</script>
  <?php 
}
...
<div class="wrapper">
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Gesion des Fonctionnaires</a>
                </div>
                <?php
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-11">
                        <div class="card">
                            <div class="header">
                                <h4 class="title text-center">Modifier Fonctionnaire</h4>
                            </div>
                            <div class="content row">
                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tel" class="form-control border-input" maxlength="10"  value="<?php echo $row['telephone'];?>" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Grade:</label>
                                                <input type="number" name="grade" max="10" min="1" class="form-control border-input"  value="<?php echo $row['grade'];?>"   required>
                                            </div>
                                        </div> 
                                        <div class="col-md-5">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Bureau:</label>
                                                <input type="text" name="bureau" class="form-control border-input"  value="<?php echo $row['bureau'];?>"   required>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Date Embauche:</label>
                                                <input type="date" name="date_entre" class="form-control border-input"  value="<?php echo $row['date_entre'];?>" required>
                                            </div>
                                        </div> 
                                    </div>
                                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-center btn-group">
                                                <a href="fonctionnaire.php" class="btn btn-info">Annuler</a>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'ti-check',
                message: " fonctionnaire bien modifié."
