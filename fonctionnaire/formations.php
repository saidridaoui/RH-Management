...
mysql_query("update notification set seen=1 where link='formation' and person_id=$id and type_person='fonct'");

?>
<!doctype html>
<html lang="en">
<head>
    <title>FORMATIONS | SWAG</title>
    <?php
                        ...
                        <div class="card" style="padding: 20px;">
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover" id="formation">
                                    ...
                                    <tbody>
                                    <?php
                                    $query1 = mysql_query("SELECT * FROM formation, location_details,stlocation WHERE location_details.fonct_id=$id and stlocation.stdev_id=location_details.stdev_id and formation.fonct_id=$id");
                                        ...
                                        while ($data = mysql_fetch_array($query1)) {
                                            ...
                                            <!-- <td>
                                                <div class="form-group">
                                                    <label for="ch" class="control control--checkbox checkbox">
                                                        <input type="checkbox" name="choice[]" id="ch" value="">
